...
const getInitiaQuery = (searchParams) => {
    const query = {}
...
export {
    shortenText, searchProducts, filterProducts, createQueryObject, getInitiaQuery
    , sumProducts ,productQuantity ,sumPrice , sumQuantity
}